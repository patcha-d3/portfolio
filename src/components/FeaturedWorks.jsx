...
const SELECTED_WORK_IDS = ['gotit', 'healu', 'qooked', 'castleread', 'bacchuss', 'uber']
    ...
    <section className="home-works" id="works">
      <div className="home-works__header">
        ...
        <div className="home-works__subtitle">
          <h3>This is a collection of professional and academic case studies that I’m proud to present.</h3>
        </div>
